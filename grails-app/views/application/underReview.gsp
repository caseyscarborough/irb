...
<head>
  ...
  <title><g:message code="application.under.review.label" /></title>
</head>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10 col-sm-12">
      ...
      <h3><g:message code="application.under.review.label" /></h3>
      ...
      <g:else>
        <div class="alert alert-info">
          <g:message code="application.under.review.no.records" />
        </div>
      </g:else>
    </div>
  </div>
